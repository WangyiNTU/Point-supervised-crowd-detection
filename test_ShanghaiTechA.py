...
C.num_scale = 1
C.down = 1
cache_path = 'data/cache/ShanghaiTechA/test'
...
if C.offset:
    w_path = 'output/valmodels/ShanghaiTechA/%s/off' % (C.scale)
    out_path = 'output/valresults/ShanghaiTechA/%s/off' % (C.scale)
else:
    w_path = 'output/valmodels/ShanghaiTechA/%s/nooff' % (C.scale)
    out_path = 'output/valresults/ShanghaiTechA/%s/nooff' % (C.scale)
